...
const Register = () => {
  ...
  return (
    ...
    //               setInputs({ ...inputs, fullName: e.target.value })
    //           }
    //           className="Input" id="fullname" placeholder="John Doe" />
    //         </Flex>
    //         <Flex style={{ marginTop: "4px" }} direction="column" gap="1" className="Fieldset">
    ...
    //           type='email' className="Input" id="email" placeholder="abc@email.com" />
    //         </Flex>
    //         <Flex gap="1" style={{ marginTop: "4px" }} direction="column" className="Fieldset">
    //           <label className="Label" htmlFor="password">
    //             Password
    //           </label>
    //           <input radius="small" type="password" className="Input" id="password" placeholder="******"
    //           value={inputs.password}
